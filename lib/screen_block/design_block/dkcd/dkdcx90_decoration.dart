...
import 'package:untitled1/screen_block/paint/path_paint_xoay_phai.dart';

class Dkdcx90Decoration extends StatelessWidget {
  const Dkdcx90Decoration({
    Key? key,
    ...
    return Stack(
      children: <Widget>[
        ...
        Container(
          ...
          height: 90,
          child: CustomPaint(
            foregroundPainter: PathPaintXoayPhai(),
            //CirclePain(),
          ),
        ),
        Container(
