...
import 'package:untitled1/screen_block/paint/path_paint_xoay_trai.dart';

class Dkdcx90tDecoration extends StatelessWidget {
  const Dkdcx90tDecoration({
    Key? key,
    ...
    return Stack(
      children: <Widget>[
        ...
        Container(
          ...
          height: 90,
          child: CustomPaint(
            foregroundPainter: PathPaintXoayTrai(),
            //CirclePain(),
          ),
        ),
        Container(
